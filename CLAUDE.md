...
5. **After the QA report is generated** — ask the user: _"O relatório de QA foi gerado. Deseja abrir um Pull Request para `develop`?"_ If yes, open the PR with `gh pr create --base develop`. **NUNCA abra PR para `main`.**
